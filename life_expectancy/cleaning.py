...
def clean_data(region_code:str):
    ...
    """
    data_to_clean = pd.read_csv('../assignments/life_expectancy/data/eu_life_expectancy_raw.tsv',
    ...
    pt_data.to_csv('../assignments/life_expectancy/data/pt_life_expectancy.csv',
                   index=False)
